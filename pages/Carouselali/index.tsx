...
import Image from "next/image"
import { GrFormNextLink, GrFormPreviousLink } from "react-icons/gr"
>>>>>>> 9f24d8bca8173f28eea6619684ce5688845ce2f2
...
const contoMovali = (e:MouseEvent) =>{
    setContoraliX(e.clientX)
}
  useEffect(() => {
    isMove
  }, [])
      ...
      <div className={styles.container}>
        <div className={styles.carouselali}>
          ...
          <div className={styles.toolBar}>
            <div
              onMouseDown={() => setIsMove(true)}
              onMouseUp={() => setIsMove(false)}
              onMouseMove={(e) => contoMovali(e)}
              className={styles.contorali}
              style={{
                width: `${100 / images.length}% `,
                marginLeft: `${(100 / images.length) * currentIndex}% `,
